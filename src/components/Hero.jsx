  ...
  return (
    <div className="hero">
      <div className="left-flex">
        <p className="name">Black Sherif <img src="" alt="" /></p>
        <p className="about">
          ...
          had few songs doing well then but his succes story really started
          after he released his mega hit titled "the first sermon".
        </p>
      </div>
